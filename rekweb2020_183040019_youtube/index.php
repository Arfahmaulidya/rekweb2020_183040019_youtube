...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCkXmLjEr95LVtGuIm3l2dPg&key=AIzaSyDSUYBgjer9nhyYV0flOQfK3QMRll7FYq0');
...
//latest video
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?key=AIzaSyDSUYBgjer9nhyYV0flOQfK3QMRll7FYq0&channelId=UCkXmLjEr95LVtGuIm3l2dPg&maxResult=1&order=date&part=snippet');
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-md-5">
          <div class="row">
            <div class="col-md-4">
              <img src="<?= $youtubeProfilPic ?>" class="rounded-circle img-thumbnail">
            </div>
          </div>
        </div>
      </div>
